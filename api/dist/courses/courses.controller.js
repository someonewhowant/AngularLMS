...
__decorate([
    ...
    (0, swagger_1.ApiOperation)({ summary: 'Create a new course (Teacher/Admin)' }),
...
__decorate([
    ...
    (0, roles_decorator_1.Roles)(role_enum_1.Role.TEACHER, role_enum_1.Role.ADMIN),
    (0, swagger_1.ApiBearerAuth)(),
    (0, swagger_1.ApiOperation)({ summary: 'Update a course (Teacher/Admin)' }),
    openapi.ApiResponse({ status: 200, type: require("./entities/course.entity").Course }),
    __param(0, (0, common_1.Request)()),
...
__decorate([
    ...
    (0, roles_decorator_1.Roles)(role_enum_1.Role.TEACHER, role_enum_1.Role.ADMIN),
    (0, swagger_1.ApiBearerAuth)(),
    (0, swagger_1.ApiOperation)({ summary: 'Delete a course (Teacher/Admin)' }),
    openapi.ApiResponse({ status: 200, type: require("./entities/course.entity").Course }),
    __param(0, (0, common_1.Request)()),
    __param(1, (0, common_1.Param)('id', common_1.ParseIntPipe)),
    __metadata("design:type", Function),
