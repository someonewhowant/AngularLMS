...
__decorate([
    ...
    openapi.ApiResponse({ status: 201, type: require("./entities/assignment.entity").Assignment }),
...
__decorate([
    ...
    openapi.ApiResponse({ status: 200, type: [require("./entities/assignment.entity").Assignment] }),
