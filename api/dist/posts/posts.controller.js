...
__decorate([
    ...
    (0, swagger_1.ApiOperation)({ summary: 'Create a new post (Admin/Teacher only)' }),
...
__decorate([
    ...
    (0, roles_decorator_1.Roles)(role_enum_1.Role.ADMIN, role_enum_1.Role.TEACHER),
    (0, swagger_1.ApiBearerAuth)(),
    (0, swagger_1.ApiOperation)({ summary: 'Update a post (Admin/Teacher only)' }),
    openapi.ApiResponse({ status: 200, type: require("./entities/post.entity").Post }),
    __param(0, (0, common_1.Param)('id', common_1.ParseIntPipe)),
    __param(1, (0, common_1.Body)()),
    __metadata("design:type", Function),
...
__decorate([
    ...
    (0, roles_decorator_1.Roles)(role_enum_1.Role.ADMIN, role_enum_1.Role.TEACHER),
    (0, swagger_1.ApiBearerAuth)(),
    (0, swagger_1.ApiOperation)({ summary: 'Delete a post (Admin/Teacher only)' }),
    openapi.ApiResponse({ status: 200, type: require("./entities/post.entity").Post }),
    __param(0, (0, common_1.Param)('id', common_1.ParseIntPipe)),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [Number]),
