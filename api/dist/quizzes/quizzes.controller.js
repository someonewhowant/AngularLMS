...
__decorate([
    ...
    openapi.ApiResponse({ status: 200, type: require("./entities/quiz.entity").Quiz }),
...
__decorate([
    ...
    openapi.ApiResponse({ status: 201, type: require("./entities/user-quiz-result.entity").UserQuizResult }),
    __param(0, (0, common_1.Request)()),
...
__decorate([
    ...
    openapi.ApiResponse({ status: 200, type: [require("./entities/user-quiz-result.entity").UserQuizResult] }),
    __param(0, (0, common_1.Request)()),
    __metadata("design:type", Function),
